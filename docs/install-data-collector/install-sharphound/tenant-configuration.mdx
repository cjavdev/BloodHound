...
Kick a collection off immediately. See [Run an On Demand Scan](/hc/en-us/articles/Run-an-On-Demand-Scan)
...
| **Option** | **Description** |
| --- | --- |
| Data (Required) | Multi-select option for the different types of collection available. See [SharpHound Data Collection and Permissions](/hc/en-us/articles/SharpHound-Enterprise-Data-Collection-and-Permissions) for details on the data collected and permissions necessary for each. |
