...
1.  Configure Azure: [AzureHound Enterprise Azure Configuration](/hc/en-us/articles/AzureHound-Enterprise-Azure-Configuration)
2.  Create your AzureHound configuration: [AzureHound Enterprise Local Configuration](/hc/en-us/articles/Create-an-AzureHound-Configuration)
3.  Deploy and maintain AzureHound: [Run and Upgrade AzureHound (Windows, Docker, or Kubernetes)](/hc/en-us/articles/Install-and-Upgrade-AzureHound-Windows-Docker-or-Kubernetes)
