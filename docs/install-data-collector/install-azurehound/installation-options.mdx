...
1.  Use the attached sample file: [docker-compose.yaml](https://support.bloodhoundenterprise.io/assets/9325923144347)
...
```
3.  A sample deployment.yaml file is attached to this article [here](https://support.bloodhoundenterprise.io/assets/9326136548635).
