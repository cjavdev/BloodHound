...
1.  Follow the [AzureHound Enterprise System Requirements and Deployment Process](/hc/en-us/articles/AzureHound-Enterprise-System-Requirements-and-Deployment-Process) through deployment in step 3. Deploy and maintain AzureHound: [Run and Upgrade AzureHound (Windows, Docker, or Kubernetes).](/hc/en-us/articles/Install-and-Upgrade-AzureHound-Windows-Docker-or-Kubernetes)
