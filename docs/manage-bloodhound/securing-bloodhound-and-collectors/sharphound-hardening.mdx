...
<Frame>
  <img src="/assets/image-2-1-1.jpg"/>
</Frame>
...
Follow the article: [Create a GMSA for use with SharpHound Enterprise](/resources/guides/create-gmsa-for-sharphound).
...
Follow the article: [Deploying a tiered SharpHound Enterprise collector strategy](/resources/guides/tiered-sharphound-strategy).
